...
This module defines the trust-based routing protocols framework
which can be used to transform an existing routing protocol
into a trust based variation.

This module was written by Jude Niroshan from Sri Lanka Institute
of Information Technology(SLIIT). It has been developed in Google 
Summer of Code 2018 under the mentorship of Tommaso Pecorella from
